...
function loadEvents() {
  ...
  function setDependencies(param, value) {
    ...
    if (param == "Introduction" && value == "0") { // Syllables
    ...
    else if (param == "Introduction" && value == "1") { // Score
      $("#truthGridEnabled option[key='True']").prop('selected', false);
    ...
    else if (param == "Introduction" && value == "2") { // Characters
      $("#truthGridEnabled option[key='True']").prop('selected', false);
      $("#syllablesEnabled option[key='True']").prop('selected', false);
      $("#voicesEnabled option[key='True']").prop('selected', false);
      $("#circlesEnabled option[key='True']").prop('selected', false);
    ...
    else if (param == "Introduction" && value == "3") { // Voices

      $("#Syllables option[key^='none']").prop('selected', true);
    ...
    else if (param == "Syllables" && value == "0") { // syllableTypes

      $("#Introduction option[key^='none']").prop('selected', true);
    ...
    else if (param == "Syllables" && value == "1") { // syllableRotation
    ...
    else if (param == "Syllables" && value == "2") { // syllableTruthGrid
    ...
    else if (param == "Phases") { // syllableTruthGrid
      ...
      $("#Introduction option[key^='none']").prop('selected', true);
      $("#Syllables option[key^='none']").prop('selected', true);
      // $("#Phases option[key^='none']").prop('selected', true);
